...
class FeetechMotorsBus:
    ...
    def _write(
        ...
        if apply_calibration and data_name in CALIBRATION_REQUIRED and self.calibration is not None:
    ...
    def write(self, data_name, values: int | float | np.ndarray, motor_names: str | list[str] | None = None):
        self._write(data_name, values, motor_names=motor_names, apply_calibration=True)

    def write_raw(self, data_name, values: int | float | np.ndarray, motor_names: str | list[str] | None = None):
        self._write(data_name, values, motor_names=motor_names, apply_calibration=False)
